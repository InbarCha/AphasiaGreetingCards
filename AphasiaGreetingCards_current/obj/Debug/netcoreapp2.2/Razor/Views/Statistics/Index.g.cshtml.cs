#pragma checksum "C:\Users\Inbar\Desktop\WebAppCourse\AphasiaGreetingCards\AphasiaGreetingCards_current\Views\Statistics\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "6166cd9ce45898a3990f066a1ebb97df6a79166e"
// <auto-generated/>
...
#line default
#line hidden
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"6166cd9ce45898a3990f066a1ebb97df6a79166e", @"/Views/Statistics/Index.cshtml")]
...
");
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "6166cd9ce45898a3990f066a1ebb97df6a79166e4369", async() => {
            }
            );
...
<!--Script For Word Counting-->
        ...
        (function () {
            ...
            function draw(words) {
                d3.select(""#words"").append(""svg"")
                    ...
                    .append(""g"")
                    .attr(""transform"", ""tra");
            WriteLiteral(@"nslate("" + layout.size()[0] / 2 + "","" + layout.size()[1] / 2 + "")"")
                    .selectAll(""text"")
                    .data(words)
                    .enter().append(""text"")
    ...
    <script>
        ...
        // The radius of the pieplot is half t");
            WriteLiteral(@"he width or half the height (smallest one). I subtract a bit of margin.
